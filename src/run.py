...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_dataset', type=str, default="('custom_test',)", help='custom test dataset')
    ...
    # --------------------------------TTA option--------------------------------
    parser.add_argument('--aug', type=str, default='True', help='Augmentation option')
    parser.add_argument('--h_flip', type=str, default='True', help='horizontal flip')
    parser.add_argument('--multi_scale', type=str, default='True', help='multi scale TTA')
    # ---------------------------------------------------------------------------
